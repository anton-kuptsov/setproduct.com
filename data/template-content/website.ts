export const websiteContent = {
  ...
  "video": {
    "url": "https://www.youtube-nocookie.com/embed/KljITlYvAnU",
    "title": "‍Organised web UI kit",
    "subtitle": "This web design library is properly named and organised. Blocks are easy to customise, adjust and fit together."
  },
  "carousels": [
    {
      "title": "140+ web blocks",
      "subtitle": "Hero covers, Navigation, Product features, Cards, Tables, Call to action, Pricing plans, Forms, Image grids, Testimonials, FAQ, Footers, Roadmap, Calculator, Code snippet and others.",
